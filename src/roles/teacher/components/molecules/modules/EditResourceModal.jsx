...
const EditResourceModal = ({ form, onClose, onSubmit, onUpdate }) => (
  <ModalShell
    title="Editar recurso"
    subtitle="Modifica el titulo del archivo o enlace."
    onClose={onClose}
    footer={(
      <div className="flex items-center justify-end gap-2">
        ...
        <button type="submit" form="edit-resource-form" disabled={form.saving} className="px-4 py-2 bg-sky-600 text-white rounded-xl text-sm font-semibold shadow-sm hover:bg-sky-700 disabled:opacity-60">
          {form.saving ? 'Guardando...' : 'Guardar cambios'}
        </button>
      </div>
    )}
  >
    <form id="edit-resource-form" onSubmit={onSubmit} className="space-y-3">
      <div>
